...
// 4. Afiseaza propozitia: “Ma numesc xxx yyy si vreau
// sa invat javascript.” Foloseste notatia cu
// paranteze patrate pentru skillul javascript.
console.log(
  `Ma numesc ${person.name} ${person.surname} si vreau sa invat ${person.skills[1]}`,
);

// 5. Afiseaza propozitia “Sunt xxx si stiu HTML si CSS.”.
// Nu folosi valoarea din arrayul de skills.
console.log(`Sunt ${person.name} si stiu HTML si CSS`);
console.log(
  `Sunt ${person.name} si stiu
  ${person.skills[0].toUpperCase()} si
  ${person.skills[2].toUpperCase()}`,
);

// 6. Afiseaza propozitia “Am x prieteni: Larryson,
// Stevenson si Carolson.”. Foloseste proprietatea length
...
console.log(`Am ${person.friends.length} prieteni:
  ...
  ${person.friends[1].surname} si
  ${person.friends[2].surname}.`);

// 7. Afiseaza propozitia “Numele meu este xxx yyy,
// am zz ani si n prieteni.”. Foloseste metoda length
// pentru a calcula lungimea arrayului de prieteni.
console.log(
  `Numele meu este ${person.name} ${person.surname},
  am ${person.age} ani si ${person.friends.length} prieteni.`,
);
